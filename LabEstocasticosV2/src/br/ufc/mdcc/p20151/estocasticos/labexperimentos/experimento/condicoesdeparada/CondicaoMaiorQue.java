...
public class CondicaoMaiorQue extends Condicao {

	public CondicaoMaiorQue(Fase fase) {
		super(fase);
		// TODO Auto-generated constructor stub
	}

	public CondicaoMaiorQue(Fase fase, int valorDeReferencia) {
		super(fase, valorDeReferencia);
		// TODO Auto-generated constructor stub
	}

	public CondicaoMaiorQue(Fase fase, Elemento elementoDeReferencia) {
